...
public class GraduateStudent extends Student {
    ...
    public GraduateStudent(String username, String major, String researchTopic, String advisor, boolean isTeachingAssistant) {
        super(username, major); // Initialize superclass (Student) with username and major
    ...
    // Override toString method to provide a string representation of the GraduateStudent
    @Override
